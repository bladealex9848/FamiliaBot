...
APP_IDENTITY = {
    ...
    "version": "1.0.0",
    "icon": "👨‍👩‍👧‍👦",
    "tagline": "Tu asistente en derecho de familia en Colombia",
    "full_title": "Bienvenido a FamiliaBot 👨‍👩‍👧‍👦",
    
    # Información del desarrollador
    "developer": "Alexander Oviedo Fadul",
    "github_url": "https://github.com/bladealex9848",
    "website_url": "https://alexanderoviedofadul.dev/",
    "docs_url": "https://github.com/bladealex9848/FamiliaBot/blob/main/README.md",
    ...
    "repository_url": "https://github.com/bladealex9848/FamiliaBot",
    
    # Descripción de la aplicación - formas corta y larga
    "short_description": "Tu asistente para comprender el derecho de familia en Colombia.",
    "long_description": """
    ...
    *Recuerda: Proporciono información general basada en mi conocimiento actual, que incluye el Código Civil Colombiano, la Ley 1564 de 2012, la Ley 1098 de 2006, la Ley 2388 de 2024, jurisprudencia relevante de la Corte Suprema de Justicia, y la Ley 1996 de 2019. Para asesoría legal específica para tu caso, consulta a un abogado.*
    ...
    # User instructions
    "usage_instructions": """
    1. **Consultas generales**: Escribe tu pregunta en el chat para recibir información sobre derecho de familia en Colombia.

    2. **Temas específicos**: Puedes preguntar sobre matrimonio, divorcio, custodia, alimentos, régimen de visitas, uniones maritales, etc.

    3. **Procesos judiciales**: Consulta información sobre trámites, requisitos y procedimientos en asuntos de familia.

    4. **Derechos y obligaciones**: Pregunta sobre tus derechos y obligaciones como padre, madre, cónyuge o miembro de la familia.

    5. **Normativa aplicable**: Solicita referencias a leyes y jurisprudencia relevante en casos de derecho de familia.
    """,
    ...
    - Extraer texto de documentos legales relacionados con derecho de familia
    - Analizar el contenido de documentos a la luz de la normativa colombiana
    - Identificar información relevante para tu caso de familia
    - Facilitar el análisis de documentos como sentencias, acuerdos o demandas
    ...
    **Nota sobre privacidad**: Los documentos se procesan localmente y no se almacenan permanentemente.
    ...
    "file_upload_default_message": "He cargado el documento '{files}' para análisis. Por favor, analiza su contenido desde la perspectiva del derecho de familia en Colombia.",
    "badges": """
    ...
    "welcome_message": """
    ### 👨‍👩‍👧‍👦 ¡Bienvenido a FamiliaBot!

    Soy tu asistente especializado en derecho de familia en Colombia. Estoy aquí para ayudarte a comprender temas legales relacionados con la familia.

    * Puedo responder preguntas sobre matrimonio y divorcio
    * Brindarte información sobre custodia y régimen de visitas
    * Explicarte conceptos sobre obligaciones alimentarias
    * Informarte sobre uniones maritales de hecho
    * Ayudarte a entender procesos judiciales en materia de familia
    ...
    **¿En qué puedo ayudarte hoy?**
    ...
    "document_prefix": "familiabot",
    "conversation_export_name": "familiabot_conversacion",
}
